...
- Check keyboard navigation for header menu, links, buttons, and FAQ details.
- Confirm every page has one `h1`.
- Confirm images have appropriate alt text.
- Decide whether the site will remain static HTML or move to Astro/Vite before launch.

## Privacy And Approval

- Do not publish raw employer prospect emails from `raw/QSE Career Fair - Sheet1.csv`.
- Get approval before publishing any company as attending or sponsoring.
- Get approval before publishing budget, revenue, or internal planning numbers.
- Confirm whether the copied UD logo assets are acceptable for this site and deployment context.
- Confirm that the published member headshots and bios are approved for public posting.

## Nice To Have

- Add a downloadable employer one-pager or sponsorship PDF.
- Add a student RSVP or interest form.
- Add a news/accomplishments section with photos from QSES events.
- Add structured data or metadata for the career fair page.
- Add lightweight analytics only if the club or university wants it.
