        ...
        return this.each(function () {
            ...
            if(settings.halfCircle) {
                ...
                circleContainer
                    ...
                    .append(
                        $('<svg width="100%" height="100%" preserveAspectRatio="xMidYMin slice"  xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 194 186" class="circliful">' +
                            elements +
...
JAtom.prototype = {
    ...
    _parse: function(xml) {
        ...
        this.version = '1.0';
        this.source = $(channel).find('source:first').text();
        ...
        $('entry', xml).each( function() {
            ...
            item.source = $(this).find('source').eq(0).text();
